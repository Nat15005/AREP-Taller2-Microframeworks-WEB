...
public class RequestHandler {
    ...
    public static void handleClient(Socket clientSocket) throws IOException {
        ...
        // Manejo de rutas específicas según el metodo HTTP
        if (method.equals("GET")) {
            ...
            // Leer los encabezados antes de manejar el POST
            ...
            // Leer los encabezados antes de manejar el DELETE
            HashMap<String, String> headers = readHeaders(in, out);
            if (headers == null) return;
            handleDelete(headers, in, out);
        } else {
            WebFramework.handleRequest(method, resource, queryParams, out);  // Para otras rutas generales
        }
